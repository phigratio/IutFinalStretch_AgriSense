...
export function broadcastSms(message: string): Promise<BdappsResult> {
  return apiFetch<BdappsResult>("/api/bdapps/broadcast", {
    method: "POST",
    body: { message },
  });
}
...
export function requestOtp(mobile: string): Promise<BdappsResult> {
  return apiFetch<BdappsResult>("/api/bdapps/otp/request", {
    method: "POST",
    body: { mobile },
  });
}
...
export function verifyOtp(input: { referenceNo: string; otp: string }): Promise<BdappsResult> {
  return apiFetch<BdappsResult>("/api/bdapps/otp/verify", {
    method: "POST",
    body: input,
  });
}
...
export function queryBalance(mobile: string): Promise<BdappsResult> {
  return apiFetch<BdappsResult>("/api/bdapps/balance", {
    method: "POST",
    body: { mobile },
  });
}
...
export function listPaymentInstruments(mobile: string): Promise<BdappsResult> {
  return apiFetch<BdappsResult>("/api/bdapps/pi", {
    method: "POST",
    body: { mobile },
  });
}
...
export function subscriptionStatus(mobile: string): Promise<BdappsResult> {
  return apiFetch<BdappsResult>("/api/bdapps/subscription/status", {
    method: "POST",
    body: { mobile },
  });
}
...
export function subscribe(mobile: string): Promise<BdappsResult> {
  return apiFetch<BdappsResult>("/api/bdapps/subscription/subscribe", {
    method: "POST",
    body: { mobile },
  });
}
...
export function unsubscribe(mobile: string): Promise<BdappsResult> {
  return apiFetch<BdappsResult>("/api/bdapps/subscription/unsubscribe", {
    method: "POST",
    body: { mobile },
  });
}
